      ...
      <>
        <Router>
          <Switch>
            ...
            <Route
              exact
              path="/register/labourer"
              render={(props) => <LabourerRegister {...props} />}
            />
            ...
            <ProtectedRoute
              exact
              path="/job/:id/safetymeetings"
              component={SafetyMeetingsDetail}
            />
            <ProtectedRoute
              exact
              path="/incident/:id"
            ...
            <ProtectedRoute
              exact
              path="/invoice/:id/:startdate/:enddate"
              component={InvoiceDetail}
            />
            <ProtectedRoute
              exact
              path="/payroll/:id/:startdate/:enddate"
            ...
            <ProtectedRoute
              exact
              path="/editjob/:id"
              component={ClientUpdateJobDetails}
            />
            <ProtectedRoute
              exact
              path="/job/:id/attendance/:date"
              act
              component={ClientLabourerAttendance}
            />
            <ProtectedRoute
              exact
              path="/addincident"
              component={ClientAddIncident}
            />
            ...
            <ProtectedRoute
              exact
              path="/admin/payrates"
              component={AdminPayrates}
            />
            <ProtectedRoute
              exact
              path="/admin/skill/:id"
              component={AdminSkillDetails}
            />
            <ProtectedRoute
              exact
              path="/admin/addskill"
              component={AdminNewSkill}
            />
